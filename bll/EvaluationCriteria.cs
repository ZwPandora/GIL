...
{
    public class EvaluationCriteriaBll : AbstractCacheManager<EvaluationCriteria>
    {
        private readonly IEvaluationCriteriaDal dal = DataAccess.CreateEvaluationCriteriaDal();
        public EvaluationCriteriaBll()
        { }
        #region  成员方法
        ...
        /// 得到一个对象实体
        /// </summary>
        public override EvaluationCriteria GetModel(int ID)
        {
        ...
        {
            List<EvaluationCriteria> list = GetAllList();
            foreach (EvaluationCriteria item in list)
            {
